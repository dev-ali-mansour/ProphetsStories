...
public class StoryActivity extends AppCompatActivity {
    private TextView txtProphet, txtContent;
    private View adView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            txtProphet = (TextView) findViewById(R.id.txt_prophet);
            txtContent = (TextView) findViewById(R.id.txt_content);
            txtProphet.setText(bundle.getString("prophet"));
    ...
    public Intent doShare() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "قصص الأنبياء - " + txtProphet.getText());
